<!--Xử lý trên database với truy vấn sửa thông tin người dùng-->
...
if ($username == $username_new) {
    if ($_POST['password'] != "") {
        ...
        $edited = $conn->query("UPDATE info SET name='$name_new', email='$email_new', phone_number='$phone_number_new' WHERE username='$username'");
    }
} else {
    if ($_POST['password'] == "") {
        $password_new = $_SESSION['password_edit'];
    }
